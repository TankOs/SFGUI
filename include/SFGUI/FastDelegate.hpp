...
// Suppress warnings about unused typedefs in GCC 4.7.0 or later
#if defined( __GNUC__ ) && ( ( __GNUC__ > 4 ) || ( ( __GNUC__ == 4 ) && ( __GNUC_MINOR__ >= 7 ) ) )
	#define SFGUI_UNUSED_ATTRIBUTE __attribute__( ( unused ) )
#else
	#define SFGUI_UNUSED_ATTRIBUTE
#endif
...
inline OutputClass horrible_cast(const InputClass input){
	...
	typedef int ERROR_CantUseHorrible_cast[sizeof(InputClass)==sizeof(u)
		&& sizeof(InputClass)==sizeof(OutputClass) ? 1 : -1] SFGUI_UNUSED_ATTRIBUTE;
	u.in = input;
	return u.out;
}
...
struct SimplifyMemFunc {
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind,
		...
		typedef char ERROR_Unsupported_member_function_pointer_on_this_compiler[N-100] SFGUI_UNUSED_ATTRIBUTE;
		return 0;
	}
};
...
// support static_cast between void * and function pointers.
	...
	inline void bindstaticfunc(DerivedClass *pParent, ParentInvokerSig static_function_invoker,
		...
		typedef int ERROR_CantUseEvilMethod[sizeof(GenericClass *)==sizeof(function_to_bind) ? 1 : -1] SFGUI_UNUSED_ATTRIBUTE;
...
//		m_pthis = reinterpret_cast<GenericClass *>(reinterpret_cast<long>(function_to_bind));
	...
	inline UnvoidStaticFuncPtr GetStaticFunction() const {
		...
		// and data pointers have different sizes.
		// If you get this error, you need to #undef FASTDELEGATE_USESTATICFUNCTIONHACK.
		typedef int ERROR_CantUseEvilMethod[sizeof(UnvoidStaticFuncPtr)==sizeof(this) ? 1 : -1] SFGUI_UNUSED_ATTRIBUTE;
...
public:
	...
	Delegate(Y *pthis, DesiredRetType (X::* function_to_bind)() ) {
	...
	template < class X, class Y >
	Delegate(const Y *pthis, DesiredRetType (X::* function_to_bind)() const) {
	...
	Delegate(DesiredRetType (*function_to_bind)() ) {
	...
	inline void Bind(DesiredRetType (*function_to_bind)()) {
		m_Closure.bindstaticfunc(this, &Delegate::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
	detail::DefaultVoid operator() () const {
...
private:	// Invoker for static functions
	detail::DefaultVoid InvokeStaticFunction() const {
