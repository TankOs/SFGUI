...
void GuessMyNumber::Run() {
	...
	new_game_button->GetSignal( sfg::OnLeftClick ).Connect( &GuessMyNumber::OnNewGameClick, this );

	m_guess_button->SetId( "guess" );
	m_guess_button->GetSignal( sfg::OnLeftClick ).Connect( &GuessMyNumber::OnGuessClick, this );
